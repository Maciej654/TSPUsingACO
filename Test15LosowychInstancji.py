...
if __name__ == '__main__':
    ...
    fileName = "WynikiInstancji15Losowych.txt"
    file = open(fileName, "w")
    file.write("n;ACO;Greedy\n")


    i=1
    while i<16:
        fileRandomName="Random"+str(i)+".txt"
        contents = open(fileRandomName, "r").readlines()  # load data

        n = int(contents[0]) # number of vertex
        print("wyniki dla "+str(n)+" wierzcholkow: ")
        ...
        file.write(str(n)+";"+str(AcoSol[0])+";"+ str(greedySol[0])+"\n")
        print("---------------------------------------------------------------------")
        i=i+1